...
public class TheaterController {
	...
	public ApiResponse<List<TheaterResponse.TheaterListResponse>> getTheaters() {
		List<TheaterResult> results = getTheaterUseCase.getTheaters();
		List<TheaterResponse.TheaterListResponse> response = responseMapper.toTheaterListResponse(results);
	...
	public ApiResponse<TheaterResponse.TheaterDetailResponse> getTheaterDetail(
		...
		TheaterDetailResult result = getTheaterUseCase.getTheaterDetail(theaterId);
		TheaterResponse.TheaterDetailResponse response = responseMapper.toTheaterDetailResponse(result);
