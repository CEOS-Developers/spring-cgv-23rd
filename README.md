...
```jsx
HTTP
http_req_duration..............: avg=128.84ms min=14.68ms med=40.04ms max=30.18s p(90)=63.66ms p(95)=78.37ms
  { expected_response:true }...: avg=86.01ms  min=25.09ms med=42.35ms max=30.18s p(90)=65.34ms p(95)=80.68ms
http_req_failed................: 22.36% 2563 out of 11460
http_reqs......................: 11460  42.189257/s
```
...
p(95)=81ms는 50 VU 동시 처리 상황에서도 병목 X (즉, 전체 앱 성능은 빠름)
...
- 10% 예정된 실패
- 0.6% cancel 실패 (연쇄 효과로 예약 실패 42% 발생)
- 1건 30초의 극단적인 응답 시간
